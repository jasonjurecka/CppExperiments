...
inline typename std::enable_if<I == sizeof...(Tp) &&
	...
	add(const std::tuple<Tp...>& /*unused*/, const std::tuple<Tp...>& /*unused*/, std::tuple<Tp...>& /*unused*/)
{ }

template<std::size_t I = 0, typename... Tp>
inline typename std::enable_if < I < sizeof...(Tp), void>::type
	add(const std::tuple<Tp...>& left, const std::tuple<Tp...>& right, std::tuple<Tp...>& result)
{
	std::get<I>(result) = std::get<I>(left) + std::get<I>(right);
	add<I + 1, Tp...>(left, right, result);
}

template<std::size_t I = 0, typename... Tp>
inline typename std::enable_if<I == sizeof...(Tp) &&
	enable_vector_math_operators<std::tuple<Tp...>>::basic, void>::type
	add(const std::tuple<Tp...>& /*unused*/, const float& /*unused*/, std::tuple<Tp...>& /*unused*/)
{ }

template<std::size_t I = 0, typename... Tp>
inline typename std::enable_if < I < sizeof...(Tp), void>::type
	add(const std::tuple<Tp...>& left, const float& right, std::tuple<Tp...>& result)
{
